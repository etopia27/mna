	...
	styleUI : {
		jQueryUI : {
			common : {
				...
				cancelButton : "ui-corner-all ui-state-grey",
...
$.jgrid.extend({
	editGridRow : function(rowid, p){
		...
		return this.each(function(){
			...
			bC  ="<a id='cData' class='fm-button " + commonstyle.cancelButton + "'>"+p.bCancel+"</a>";
	...
	delGridRow : function(rowids,p) {
		...
		return this.each(function(){
			...
			if ( $("#"+$.jgrid.jqID(IDs.themodal))[0] !== undefined ) {
				...
				bC  = "<a id='eData' class='fm-button " + commonstyle.cancelButton + "'>"+p.bCancel+"</a>";
